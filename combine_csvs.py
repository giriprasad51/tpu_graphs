...
_DEFAULT_INPUTS = [
    ...
    (_LAYOUT_NLP_RANDOM_CSV, '/kaggle/input/google-fast-or-slow-4/out/tpugraphs_layout/results_*_nlp_random.csv'),
    (_LAYOUT_NLP_DEFAULT_CSV,
     '/kaggle/input/google-fast-or-slow-5/out/tpugraphs_layout/results_*_nlp_default.csv'),
    (_LAYOUT_XLA_RANDOM_CSV, '/kaggle/input/google-fast-or-slow-2/out/tpugraphs_layout/results_*_xla_random.csv'),
